...
if ($LASTEXITCODE -ne 0) { throw "Step failed: RS07 train fold 0 (exit code $LASTEXITCODE)" }
nnUNetv2_train 407 3d_fullres 1
if ($LASTEXITCODE -ne 0) { throw "Step failed: RS07 train fold 1 (exit code $LASTEXITCODE)" }
nnUNetv2_train 407 3d_fullres 2
if ($LASTEXITCODE -ne 0) { throw "Step failed: RS07 train fold 2 (exit code $LASTEXITCODE)" }
