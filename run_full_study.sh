...
ROOT="/data/Dataset003_v2_LiverTumorSeg"
...
echo "Please manually review outputs/manifest_proposed.csv and save reviewed file as outputs/manifest_reviewed.csv"
...
bash outputs/commands/infer_targets.sh
